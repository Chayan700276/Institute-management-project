...
<div class="well text-center">
 ...
 <h2>
    <a class="btn btn-info pull-left " href="lib_d_s_s.php">Back</a>
  </h2>
...
$lib_roll_show=$lb->Lib_Roll_Show($dept,$semester,$shift);
    ...
    <tr>
      ...
      <?php 
       ...
       ?>
      <a href="library_card.php?libid=<?php echo $result['roll'];?>"><button style="margin-top: 40px" type="submit" name="" class="btn btn-primary">Given</button></a>
